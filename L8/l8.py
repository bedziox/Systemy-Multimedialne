...
def compress_not_KeyFrame(Frame_class, KeyFrame, Rnum = 1/2, inne_paramerty_do_dopisania=None):
    Compress_data = data()
    ## TO DO 
...
def decompress_not_KeyFrame(Compress_data,  KeyFrame , Rnum = 1/2, inne_paramerty_do_dopisania=None):
    Y=Compress_data.Y
    Cb=Compress_data.Cb
    Cr=Compress_data.Cr
    ## TO DO
